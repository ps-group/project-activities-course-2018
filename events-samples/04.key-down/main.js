...
function createRandomBall({boxWidth, boxHeight}) {
    ...
    const directionX = 0;//Math.random() > 0.5 ? DIRECTION.LEFT : DIRECTION.RIGHT;
    const directionY = 0;//Math.random() > 0.5 ? DIRECTION.UP : DIRECTION.DOWN;
...
function main() {
    ...
    document.body.onkeydown = e => onKeyDown(e, ball);
    document.body.onkeyup = e => onKeyUp(e, ball);
